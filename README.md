...
FastVLM-Agent is a prototype benchmark framework designed to evaluate **multimodal AI** that process both images and text. The goal of this project is to study the **trade-off between latency (speed) and reasoning quality** in vision-language systems.
